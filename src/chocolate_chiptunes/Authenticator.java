...
class Authenticator {
    ...
    String GetHostedSignInURL() {
        ...
        return String.format(customurl, CUSTOMDOMAIN, REGION, CLIENTAPP_ID, SDK_Constants.REDIRECT_URL);
    }
     ...
     * @param nickname phone number to sign up.
     * @return whether the call was successful or not.
     */
    boolean SignUpUser(String username, String password, String email, String nickname) {
        ...
        attributeType.setValue(nickname);
    ...
    String ValidateUser(String username, String password) {
        AuthHelper helper = new AuthHelper(POOL_ID, CLIENTAPP_ID, CLIENT_SECRET);
    ...
    Credentials GetCredentials(String accesscode) {
        ...
        try {
            ...
            httpBodyParams.put(SDK_Constants.TOKEN_GRANT_TYPE, SDK_Constants.TOKEN_GRANT_TYPE_AUTH_CODE);
            httpBodyParams.put(SDK_Constants.DOMAIN_QUERY_PARAM_CLIENT_ID, CLIENTAPP_ID);
            httpBodyParams.put(SDK_Constants.DOMAIN_QUERY_PARAM_REDIRECT_URI, SDK_Constants.REDIRECT_URL);
            httpBodyParams.put(SDK_Constants.TOKEN_AUTH_TYPE_CODE, accesscode);
            ...
            JSONObject payload = JWT_Parser.getPayload(result);
