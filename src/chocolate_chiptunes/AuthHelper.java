...
class AuthHelper {
    ...
    AuthHelper(String userPoolID, String clientid, String secretKey) {
        do {
    ...
    String PerformSRPAuthentication(String username, String password) {
        ...
        try {
            ...
            if (ChallengeNameType.PASSWORD_VERIFIER.toString().equals(initiateAuthResult.getChallengeName())) {
                ...
                System.out.println(JWT_Parser.getPayload(result.getAuthenticationResult().getIdToken()));
    ...
    private RespondToAuthChallengeRequest userSrpAuthRequest(InitiateAuthResult challenge,
        ...
        if (B.mod(AuthHelper.N).equals(BigInteger.ZERO)) {
