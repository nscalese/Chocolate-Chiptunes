...
final class HttpClient {
    ...
    String httpPost(final URL uri, final Map<String, String> bodyParams) throws Exception {
        ...
        try {
            // Request header
            httpsURLConnection.setRequestMethod(SDK_Constants.HTTP_REQUEST_TYPE_POST);
    ...
    private Map<String, String> getHttpHeader() {
        ...
        httpHeaderParams.put(SDK_Constants.HTTP_HEADER_PROP_CONTENT_TYPE,
                SDK_Constants.HTTP_HEADER_PROP_CONTENT_TYPE_DEFAULT);
